  ...
  return (
    <section className="flex flex-col justify-start gap-5">
      <div className="relative flex items-center gap-2 text-green-400">
        <h1 className={`${styles.logo_name} relative bottom-[3px] uppercase`}>
          LEARN UP
        </h1>
      </div>
      <p className="text-[#CECECE] text-justify text-[16px] leading-[30px]">
      ...
      <div className="flex justify-start items-center gap-5 mt-5">
        ...
        <a className="p-2 bg-[#55acee] text-white hover:bg-darkBg duration-300 group">
          <BsTwitter
            size={20}
